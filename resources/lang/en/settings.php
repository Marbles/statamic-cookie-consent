...
return [
    ...
    'section_text_instruct'    => 'Edit the text that is shown on the Cookie Consent.',
        ...
        'button_text_instruct' => 'Text on the close button',

    'section_link'          => 'Policy link',
    'section_link_instruct' => 'Display the read more link and change the text and url of the link.',
        'show_link'         => 'Show the policy link',
        'link_text'         => 'Policy link text',
    ...
    'section_colors_instruct' => 'Change the colors of the background and the button.',
        ...
        'color_button_border' => 'Button border color',
        'position'            => 'The position of the Cookie Consent',
        'theme'               => 'Display of the Cookie Consent',
];
